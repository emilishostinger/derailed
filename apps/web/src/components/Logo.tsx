 ...
 *
 * One flat green, no gradient. It was the only gradient left in the product and it
 * was not earning anything: flat, the mark reads identically at every size.
 */
export function Logo({ className = 'h-6 w-6' }: { className?: string }) {
  return (
    <svg viewBox="0 0 512 512" className={className} aria-hidden="true">
      <title>Derailed</title>
      <rect width="512" height="512" rx="112" fill="#7236e3" />
