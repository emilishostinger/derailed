...
/**
 * The app's README, read without leaving the drawer.
 *
 ...
 */
export function ReadmeTab({ service }: { service: Service }) {
    ...
    <div>
      ...
      {docsUrl && (
        <a
          ...
          target="_blank"
          rel="noreferrer noopener"
          className="mt-5 inline-flex items-center gap-1.5 text-[12px] text-ink-faint hover:text-ink"
        >
          Open the original
